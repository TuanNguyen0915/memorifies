  ...
  return (
    <div className="space-y-4">
      <div className="flex w-full items-center justify-evenly">
        <div className="h-[200px] w-[200px] space-y-7 rounded-xl border p-4 transition-all duration-500 hover:ring-1">
          <p className="w-full text-center text-lg font-semibold text-muted-foreground">
            Followers
          </p>
          <p className="text-center text-7xl font-extrabold text-indigo-500">
            <CountUp
              isCounting
              start={0}
